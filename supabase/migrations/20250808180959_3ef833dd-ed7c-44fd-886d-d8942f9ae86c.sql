...
DROP POLICY IF EXISTS "Users can upload their own photos with restrictions" ON storage.objects;
DROP POLICY IF EXISTS "Users can update their own photos with restrictions" ON storage.objects;
DROP POLICY IF EXISTS "Users can upload their own photos with size limit" ON storage.objects;
DROP POLICY IF EXISTS "Users can update their own photos with size limit" ON storage.objects;
